...
%% ------------------------------------------------------------------------
%% -------------------------------------------------------------------------
%% TSP Standard Functions problem : you can try per function by uncomment from fitness.m :)) 
%% Default function is : x.^2
...
for iter=1:maxiter
    ...
    prolifpop=proliferation(prolifpop,pop,data,iter,maxiter,diss);
...
%     Germination
    ...
    [pop] = [pop;prolifpop;germpop;motherpop];
%     ;
    [value,index] = sort([pop.fit]);
    pop = pop(index);
    gpop = pop(1);
